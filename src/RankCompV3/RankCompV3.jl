...
"""
function reoa( expr::DataFrame, # Expression profiles matrix 
			   meta::DataFrame;
		   fn_stem::AbstractString = "RankCompV3", # The beginning name of the save file name.
	...
	fg_name = (mg == 2) ? join([g_name[1],g_name[2]],"_") : g_name[i]
    ...
    return outcome_result[:,[:genename,:up_down]]
end
